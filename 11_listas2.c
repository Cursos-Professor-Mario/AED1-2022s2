...
void buscaInsere1(Celula *lst, int x, int y)
{
    Celula *p, *q, *nova;
    nova = malloc(sizeof(Celula));
    nova->conteudo = y;
...
int main(int argc, char *argv[])
{
    ...
    buscaInsere1(ini, 2, 3);
    imprime(ini);
    printf("buscaInsere1(ini, ini->prox->conteudo, 49)\n");
    buscaInsere1(ini, ini->prox->conteudo, 49);
    imprime(ini);
    printf("buscaInsere1(ini, 15, 17)\n");
    buscaInsere1(ini, 15, 17);
    imprime(ini);
